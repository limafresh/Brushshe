...
pyinstaller --noconfirm --onedir --windowed --icon "..\Brushshe\assets\icons\icon.ico" --add-data "brenv\Lib\site-packages\customtkinter;customtkinter/" --add-data "..\README.md;." --add-data "..\LICENSE;." --add-data "..\LICENSE-CC0;." --add-data "dependencies-licenses.txt;." --add-data "$licensePath;." --add-data "python-licenses.html;." --add-data "..\Brushshe\assets;assets/"  "..\Brushshe\main.py"
