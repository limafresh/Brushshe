...
+ **Stickers**: You can add stickers from Brushshe sticker set (all sticker images are drawn by [limafresh, founder of Brushshe](https://github.com/limafresh/), or created by Microsoft Copilot) and resize them. You can also add a sticker from a file or URL.
